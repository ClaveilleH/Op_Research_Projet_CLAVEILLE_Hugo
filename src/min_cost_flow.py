...
if __name__ == "__main__":
    ...
    try:
        max_flow, total_cost = ford_fulkerson(graph)
        print("Flot maximum pour le graph lucas :", max_flow)
        print("Coût total pour le graph lucas :", total_cost)
        from graph_to_dot import graph_to_dot
        graph_to_dot(graph, "output/mincost_graph_data.dot", show_capacity=True, show_zero=True)
    except ValueError as e: 
        print(e)